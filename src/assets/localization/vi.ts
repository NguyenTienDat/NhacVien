...
export const LOCALIZATION = {
    "en": {
        ...
        "dxScheduler-openAppointment": "Xem lịch",
        ...
        "dxScheduler-recurrenceRepeatCount": "lần",
        "dxScheduler-allDay": "Cả ngày",

        "dxScheduler-confirmRecurrenceEditMessage": "Bạn chỉ muốn thay đổi lịch ngày này hay toàn bộ lịch liên quan?",
        "dxScheduler-confirmRecurrenceDeleteMessage": "Bạn chỉ muốn xóa lịch ngày này hay toàn bộ lịch liên quan?",

        "dxScheduler-confirmRecurrenceEditSeries": "Sửa lịch liên quan",
        "dxScheduler-confirmRecurrenceDeleteSeries": "Xóa lịch liên quan",
        "dxScheduler-confirmRecurrenceEditOccurrence": "Sửa lịch này",
        "dxScheduler-confirmRecurrenceDeleteOccurrence": "Xóa lịch này",
